...
var App = React.createClass({displayName: "App",
    ...
    render: function() {
        return (
            ...
            React.createElement(PageHeader, {title: this.props.title}), 
...
},{"./pageHeader":158,"./postList":160,"react":156}],158:[function(require,module,exports){
var React = require('react'); 
...
var Post = React.createClass({displayName: "Post",
    render: function() {
        return (
            React.createElement("li", null, React.createElement("b", null, this.props.provider), " ", this.props.content)
        );
    }
}); 
...
var PostList = React.createClass({displayName: "PostList",
    ...
    render: function() {
        ...
        var content = this.props.posts.map(function(post){
            return (
                React.createElement(Post, {provider: post.provider, content: post.content})
            ); 
        });
...
},{"./post":159,"react":156}],161:[function(require,module,exports){
/*global io*/ 
/*global React*/ 
var App      = require('./components/app');  

var settings = JSON.parse(document.getElementById('settings').innerHTML); 
React.render(React.createElement(App, {title: "Social Radar", settings: settings}), document.body);

},{"./components/app":157}]},{},[161]);
